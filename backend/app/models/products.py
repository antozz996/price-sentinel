...
class ProductFeedback(Base):
    ...
    resolved_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    resolved_by_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("utenti.id", ondelete="SET NULL"), nullable=True)
    admin_action: Mapped[str | None] = mapped_column(String(50), nullable=True)
